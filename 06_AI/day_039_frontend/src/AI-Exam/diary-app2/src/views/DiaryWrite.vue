...
const saveDiary = async () => {
  ...
  await diaryStore.addDiary(newDiary);
  router.push('/');
};
...
<template>
  <div class="write-container mx-auto" style="max-width: 800px;">
    <div class="card shadow-sm border-0 p-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-warm mb-0">
          <i class="fas fa-feather-alt me-2 text-pink"></i>오늘의 기록
        </h2>
        ...
        <div class="row g-3">
          ...
          <div class="col-12 mt-5 text-center">
            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 shadow" :disabled="diaryStore.isLoading">
              <i class="fas fa-check me-2"></i>기록 완료
            </button>
          </div>
        </div>
      </form>
